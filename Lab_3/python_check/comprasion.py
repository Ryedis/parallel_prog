...
comparison['8_processes'] = [get_time(8, size) for size in matrix_sizes]
...
comparison['speedup_8vs1'] = comparison['1_process'] / comparison['8_processes']
...
plt.plot(comparison['Size'], comparison['8_processes'], 'm-o', label='8 процессов')
...
plt.plot(comparison['Size'], comparison['speedup_8vs1'], 'm--o', label='Ускорение 8 vs 1')
